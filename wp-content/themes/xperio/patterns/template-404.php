...
<?php
	esc_html_e( 'OOPS! Page Not Found!', 'xperio' );
?>
</h3>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<?php
	esc_html_e( 'Helpful Link', 'xperio' );
?>
</h2>
<!-- /wp:heading -->
...
<?php
	esc_html_e( 'Something went wrong! We couldn’t find the page you were looking for. But don’t worry, we’ve got some other Links that might be helpful:', 'xperio' );
?>
</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
...
<?php
	esc_html_e( 'Pages', 'xperio' );
?>
</h4>
<!-- /wp:heading -->

<!-- wp:page-list {"className":"is-style-xperio-page-list-bullet-hide-style is-style-xperio-page-list-bullet-hide-style","style":{"typography":{"lineHeight":"2"},"elements":{"link":{":hover":{"color":{"text":"var:preset|color|secondary"}}}}}} /--></div>
<!-- /wp:column -->
...
<h4 class="wp-block-heading has-heading-color-color has-text-color has-link-color" style="margin-bottom:var(--wp--preset--spacing--50);font-style:normal;font-weight:500">
<?php
	esc_html_e( 'Categories', 'xperio' );
?>
</h4>
<!-- /wp:heading -->

<!-- wp:categories {"className":"is-style-xperio-categories-bullet-hide-style is-style-xperio-categories-bullet-hide-style","style":{"typography":{"lineHeight":"2"},"elements":{"link":{":hover":{"color":{"text":"var:preset|color|primary"}},"color":{"text":"var:preset|color|black-color"}}}},"textColor":"black-color"} /--></div>
<!-- /wp:column -->
