 ...
 *
 * @example
 * xperio_get_feature_status_icon( true );  // Outputs a check mark icon.
 * xperio_get_feature_status_icon( false ); // Outputs a cross icon.
 * xperio_get_feature_status_icon( 'Coming Soon' ); // Outputs "Coming Soon" as a text status.
 */
function xperio_get_feature_status_icon($status)
{
	$allowed_tags = array(
		'div'  => array(
			'class' => true,
...
<div class="xperio-page__free-pro">
	<h3><?php esc_html_e('Xperio Free vs. Pro', 'xperio'); ?></h3>

	<div class="checkout-button-container top">
		<a href="<?php echo esc_url('https://cozythemes.com/pricing-and-plans/'); ?>" class="checkout-button"><?php esc_html_e('Already enjoying our product?', 'xperio'); ?></a>
	</div>

	<table>
		<tr>
			<th><?php esc_html_e('Feature', 'xperio'); ?></th>
			<th><?php esc_html_e('Free', 'xperio'); ?></th>
			<th><?php esc_html_e('Pro', 'xperio'); ?></th>
		</tr>

		<?php
		if (isset($xperio_features) && ! empty($xperio_features)) :
			foreach ($xperio_features as $feature) {
		?>
				<tr>
					<td>
						<?php
					...
					<td>
						<?php xperio_get_feature_status_icon($feature['free']); ?>
					</td>

					<td>
						<?php xperio_get_feature_status_icon($feature['pro']); ?>
					</td>
				</tr>
		<?php
			}
	...
	<br />
	<em><?php esc_html_e('Note: To use the Pro features download the ', 'xperio'); ?><strong class="xperio-setup-link"><?php esc_html_e('Recommended Plugin', 'xperio'); ?></strong></em>
	...
	<div class="refund-policy">
		...
		<div class="policy">
			<h3><?php esc_html_e('No Risk, 100% Money Back Guarantee!', 'xperio'); ?></h3>
			<p><?php esc_html_e('Our Refund Policy secures customer satisfaction and protection. If you find our purchased products unusable, despite our team’s support, you can claim a full refund within 30 days.', 'xperio'); ?></p>
		</div>
	</div>

	<!-- Checkout Button Section -->
	<div class="checkout-button-container bottom">
		<?php esc_html_e('Ready to take the next step? Let’s get you to', 'xperio'); ?> <a href="<?php echo esc_url('https://cozythemes.com/pricing-and-plans/'); ?>" class="checkout-button"><?php esc_html_e('Checkout!', 'xperio'); ?></a> <?php esc_html_e('🚀', 'xperio'); ?>
	</div>
</div>
<?php
