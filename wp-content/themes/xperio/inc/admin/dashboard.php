<?php
function xperio_get_premium_status()
{
...
function xperio_get_theme_initial($name)
{
...
function xperio_get_dashboard_pages_order(): array
{
	$pages_dir = XPERIO_DIR . 'inc/admin/pages';
...
$theme_initial = xperio_get_theme_initial($theme_name);

$pages_order = xperio_get_dashboard_pages_order();
...
?>
<div class="dashboard-about-xperio">
	<div class="xperio-about-header">
		<p id="xperio-initial">
			<?php
			printf(
		...
		<p id="xperio-version">
			<?php
			esc_html_e('Version ', 'xperio');
			echo esc_html($theme_version);

			if (xperio_get_premium_status()) :
			?>
				<svg id="xperio-premium-crown" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="xperio-about-body">
		...
		<div id="xperio-content">
			...
			<?php
					...
					echo esc_html__('File does not exist or is not readable.', 'xperio');
				}
			}
			?>
		</div>
